...
const AddDoctor = () => {
  ...
  const [specialty,setSpecialty] = useState('GeneralPhysican')
...
const onSubmitHandler = async (event) =>{
  ...
  try {
    ...
    const {data} = await axios.post(backendUrl + '/add-doctor',formData,{headers:{aToken}})
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 border-rounded w-full max-w-4xl-h-[80vh] overflow-scroll'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <select onChange={(e)=> setSpecialty(e.target.value)} value={specialty} className='border rounded px-3 py-2'>
                <option value="GeneralPhysican">General Physician</option>
        ...
        {/* Textarea & Submit Button - Moved to Bottom */}
        <div className='mt-6'>
