...
const DoctorAppointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'> {/* Corrected: w-full */}
      <p>All Appointments</p>
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
        <div className='max-sm:hidden grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-8 py-3 px-6 border-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {/* Add appointment rendering logic here */}
        {
          appointments.reverse().map((item,index)=>(
            <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-8 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
